    ...
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{
          ...
          backgroundPosition: "center 90%", // Adjusted to show even more of the bottom half
        }}
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              asChild
              size="lg"
              className="bg-blue-600 hover:bg-blue-700 text-white" // Changed to blue background with white text
            >
