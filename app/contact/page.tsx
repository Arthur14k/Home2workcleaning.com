...
export const metadata = {
  ...
  description: "Reach out to Home2Work Cleaning for a free consultation and tailored cleaning solutions.",
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{
          ...
          backgroundSize: "cover", // Ensures nothing from the photo is missing
          backgroundPosition: "center", // Centers the entire image
        }}
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 drop-shadow-lg">Contact Us</h1>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+447526229926" className="text-blue-600 hover:text-blue-700 font-medium">
                          07526229926
                        </a>
                      </div>
                    </div>
