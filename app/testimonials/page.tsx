...
export default function TestimonialsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        className="relative py-24 px-4 bg-no-repeat min-h-[50vh] flex items-center justify-center" // Added min-h and flex properties
        style={{
          backgroundImage: "url('/images/testimonials-hero.jpg')",
          backgroundSize: "contain", // Changed to 'contain' to make it smaller/zoomed out
