          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="text-center border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">Safe, non-toxic cleaning products that protect your family and environment</p>
              </CardContent>
            </Card>
            <Card className="text-center border-0 shadow-lg">
              <CardContent className="p-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <CardContent className="p-8">
                ...
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2" /> Regular house cleaning
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2" /> Deep cleaning services
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2" /> Move-in/move-out cleaning
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2" /> Post-construction cleanup
                  </li>
                </ul>
            ...
            <Card className="overflow-hidden">
              <CardContent className="p-8">
                ...
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2" /> Office cleaning
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2" /> Retail space maintenance
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2" /> Medical facility cleaning
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2" /> Janitorial services
                  </li>
                </ul>
                <Button asChild variant="outline">
                  <Link href="/services">Learn More</Link>
