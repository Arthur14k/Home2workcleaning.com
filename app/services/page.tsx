...
export default function ServicesPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        className="relative py-24 px-4 bg-cover bg-no-repeat"
        style={{
          backgroundImage: "url('/images/services-hero.jpg')",
          backgroundSize: "cover",
          backgroundPosition: "center bottom", // Adjusted to show the bottom half
        }}
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-white mb-8 drop-shadow-md max-w-3xl mx-auto">
            Comprehensive cleaning solutions tailored to your residential and commercial needs
          </p>
        </div>
      </section>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" />
                      <span>Display and shelf cleaning</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              asChild
              size="lg"
              variant="secondary" // Changed to secondary for white background
              className="text-gray-900 hover:bg-gray-100" // Adjusted text color and hover for secondary variant
            >
