...
// Booking notification email template (to business)
export function createBookingNotificationEmail(data: any) {
  const notifyFrom = process.env.NOTIFY_FROM || "contact@home2workcleaning.com"
  const notifyTo = process.env.NOTIFY_TO || "contact@home2workcleaning.com"
...
// Booking confirmation email template (to customer)
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px;">
          ...
          <ul>
            <li>Phone: <a href="tel:+447526229926">07526229926</a></li>
            <li>Email: <a href="mailto:contact@home2workcleaning.com">contact@home2workcleaning.com</a></li>
          </ul>
...
// Contact notification email template (to business)
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px; background: #f9fafb;">
          ...
          <div style="margin-top: 20px; padding: 15px; background: #dbeafe; border-radius: 5px;">
            <p style="margin: 0; color: #1e40af;">
              <strong>Quick Actions:</strong><br>
              Call ${data.firstName}: ${data.phone || "No phone provided"}<br>
              Email: ${data.email}
            </p>
          </div>
        </div>
...
// Contact confirmation email template (to customer)
        ...
        <div style="padding: 20px;">
          ...
          <div style="background: #dbeafe; padding: 15px; border-radius: 5px; margin: 20px 0;">
            <p style="margin: 0; color: #1e40af;">
              ...
              Monday - Friday: 8:00AM - 19:00<br>
              Saturday: 9:00AM - 18:00<br>
              Sunday: Closed
            </p>
          </div>
